...
public class RedisConfig {
    ...
    public RedisCacheManager cacheManager(RedisConnectionFactory connectionFactory) {
        ...
        cacheConfigs.put("videos",
                defaultConfig.entryTtl(Duration.ofSeconds(3600)));

        // Video list cache — 5 minutes (changes more frequently)
        cacheConfigs.put("videoList",
                defaultConfig.entryTtl(Duration.ofSeconds(300)));

        // Video status cache — 30 seconds (changes during processing)
        cacheConfigs.put("videoStatus",
